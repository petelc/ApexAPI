...
**Updated `tests\Apex.API.FunctionalTests\Apex.API.FunctionalTests.csproj`:**
- Removed: `Microsoft.EntityFrameworkCore.InMemory`
- Added: `Testcontainers` and `Testcontainers.MsSql`

### 2. CustomWebApplicationFactory

**File:** `tests\Apex.API.FunctionalTests\CustomWebApplicationFactory.cs`
...
```bash
dotnet test tests\Apex.API.FunctionalTests\Apex.API.FunctionalTests.csproj
```
