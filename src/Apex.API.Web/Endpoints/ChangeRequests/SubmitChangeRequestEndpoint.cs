...
/// </summary>
public class SubmitChangeRequestEndpoint : EndpointWithoutRequest
{
    private readonly IMediator _mediator;

    public SubmitChangeRequestEndpoint(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    public override async Task HandleAsync(CancellationToken ct)
    {
        ...
        var command = new SubmitChangeRequestCommand(ChangeRequestId.From(id));
