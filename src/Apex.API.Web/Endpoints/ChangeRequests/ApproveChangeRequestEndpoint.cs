...
/// </summary>
public class ApproveChangeRequestEndpoint : Endpoint<ApproveChangeRequestRequest>
{
    private readonly IMediator _mediator;

    public ApproveChangeRequestEndpoint(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    public override async Task HandleAsync(ApproveChangeRequestRequest req, CancellationToken ct)
    {
        var id = Route<Guid>("id");
        var command = new ApproveChangeRequestCommand(ChangeRequestId.From(id), req.Notes);
