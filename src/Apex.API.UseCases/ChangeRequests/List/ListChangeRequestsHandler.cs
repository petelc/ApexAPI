...
/// </summary>
public class ListChangeRequestsHandler : IRequestHandler<ListChangeRequestsQuery, Result<PagedRequestList>>
{
    private readonly IReadRepository<ChangeRequest> _repository;
    private readonly ITenantContext _tenantContext;
    private readonly ILogger<ListChangeRequestsHandler> _logger;
    public ListChangeRequestsHandler(
        IReadRepository<ChangeRequest> repository,
        ITenantContext tenantContext,
        ILogger<ListChangeRequestsHandler> logger)
    {
        ...
        CancellationToken cancellationToken)
    {
        try
        {
            ...
            // Map to DTOs
            var dtos = pagedRequests.Select(r => new ChangeRequestDto(
                r.Id.Value,
                r.Title,
                r.Description,
                r.Status.Name,
