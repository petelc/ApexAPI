...
namespace Apex.API.UseCases.ProjectRequests.Validators;

/// <summary>
/// Validator for UpdateProjectRequestCommand
/// </summary>
public class UpdateProjectRequestValidator : AbstractValidator<UpdateProjectRequestCommand>
{
